...
public class LeitorCsvController {
    ...
    private void validarCSV() {
        ...
        try {
            ...
            // Se a validação do CSV falhar, mostre a caixa de diálogo de erro e retorna
            // para escolher novamente o arquivo
    ...
    private void validarCidadeEstacao(boolean nomeInvalido) {
        // Se o nome da cidade não puder ser identificado, peça ao usuário para inserir
        // o nome da cidade
        if (nomeInvalido) {
    ...
    private Optional<String[]> mostrarDialogoNomeInvalido() {
        ...
        // se apertar o buttonTypeSair ele deve fechar o dialogo e impedir o resto do
        // codigo.
        ...
        // Ouvinte de propriedade que será acionado sempre que o texto em qualquer campo
        // for alterado
        ...
        // Defina o resultado da caixa de diálogo para ser um array com os valores dos
        // campos de entrada
